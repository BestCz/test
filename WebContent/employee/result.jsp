...
<table width="100%" border="0">
	...
	<td width="25%"><div align="center">年龄</div></td>
	
	</tr>
	
		<tr>
			<td width="25%"><div align="center">${id }</div></td>
			<td width="25%"><div align="center">${epassword }</div></td>
			<td width="25%"><div align="center">${ename }</div></td>
			<td width="25%"><div align="center">${age }</div></td>
		</tr>
