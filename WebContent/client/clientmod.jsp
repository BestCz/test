...
<div id="content">
	<div class="left_menu">
		...
		<div class="m-right">
			...
			<div class="main">
				<div align="center">
						<form action="../ClientMod">
							<%String id=request.getParameter("id");%>
							<br><br><br><br>
								&nbsp;&nbsp;&nbsp;&nbsp;<span style="font-size:30px; font-weight:bold;">修改客户信息
	<br><br>
							<span style="font-size:15px; font-weight:bold;">姓名:<input type="text" name="cname" ><br>
							<span style="font-size:15px; font-weight:bold;">账号:<input type="text" name="cid" value="<%=id%>"><br>
